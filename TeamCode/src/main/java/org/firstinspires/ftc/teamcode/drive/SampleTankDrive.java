 ...
 * EDITED TO REFLECT OUR ROBOT :D
 */
@Config
public class SampleTankDrive extends TankDrive {
    public static PIDCoefficients AXIAL_PID = new PIDCoefficients(0, 0, 0); //TBM
    public static PIDCoefficients CROSS_TRACK_PID = new PIDCoefficients(0, 0, 0); //TBM
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0, 0, 0); //TBM
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftDrive = hardwareMap.get(DcMotorEx.class, "left");
        DcMotorEx rightDrive = hardwareMap.get(DcMotorEx.class, "right");
